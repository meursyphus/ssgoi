...
@Component({
  ...
  host: {
    class: 'max-w-6xl mx-auto px-4 py-12 sm:py-20',
  },
  template: `
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-20">
      <div class="bg-gray-800/50 p-6 rounded-lg backdrop-blur">
        ...
        <h3 class="text-lg font-semibold text-white mb-2">Works Everywhere</h3>
      ...
      <div class="bg-gray-800/50 p-6 rounded-lg backdrop-blur">
        ...
        <p class="text-gray-400 text-sm">Keep your existing routing solution</p>
      </div>
    </div>
  `,
})
