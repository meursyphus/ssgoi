...
See all 13 transitions live on the [demos page](/showcase), or read the [docs](/docs).
...
Two steps — wrap once, mark your pages — and the App Router feels like a native app, in every browser, without giving up server rendering. Browse the [demos](/showcase) to find the exact transition you want and copy its config.
