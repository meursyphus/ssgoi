  ...
  return (
    <section>
      <header className="mb-2 flex items-end justify-between">
        <div>
          <h2 className="text-[16px] font-semibold tracking-tight">재생목록</h2>
          <p className="mt-1 text-[12px] text-white/55">
            {detail.artist} 라디오 • 무한 재생
          </p>
        </div>
        <button
          type="button"
        ...
        {detail.upNext.map((s, idx) => (
          ...
          >
            <button
              ...
              className="flex h-10 w-10 shrink-0 items-center justify-center text-[12px] text-white/55"
            >
