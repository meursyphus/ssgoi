...
export async function StructuredData() {
  ...
  const websiteStructuredData = {
    ...
    potentialAction: {
      ...
      target: {
        "@type": "EntryPoint",
        urlTemplate: `https://ssgoi.dev/docs?search={search_term_string}`,
      },
  ...
  const softwareStructuredData = {
    ...
    description: messages.homeStructuredData.app.description,
    url: "https://ssgoi.dev",
    ...
    keywords: messages.homeStructuredData.app.keywords,
    featureList: [
  ...
  const navigationStructuredData = {
    ...
    name: [messages.header.docs, messages.header.blog, "GitHub"],
    url: [
      `https://ssgoi.dev/docs`,
      `https://ssgoi.dev/blog`,
      "https://github.com/meursyphus/ssgoi",
    ],
  };
