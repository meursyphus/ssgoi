...
export async function DocsStructuredData({
  ...
  const structuredData = {
    ...
    description:
      description ||
      `${messages.docsStructuredData.defaultDescription} ${title}`,
    url: url,
    author: {
      "@type": "Person",
      name: "MeurSyphus",
    ...
    isPartOf: {
      "@type": "WebSite",
      name: messages.docsStructuredData.siteName,
      url: "https://ssgoi.dev",
    },
  };
  ...
  if (prevDoc) {
    relatedPages.push({
      ...
      url: `https://ssgoi.dev/docs/${prevDoc.path}`,
      position: "previous",
    });
  }
  if (nextDoc) {
    relatedPages.push({
      ...
      url: `https://ssgoi.dev/docs/${nextDoc.path}`,
      position: "next",
    });
  }
