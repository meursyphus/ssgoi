...
export const products: Product[] = [
  {
    ...
    description:
      "Experience crystal-clear audio with our latest noise-cancelling technology. Perfect for music lovers and professionals.",
    price: 299.99,
  ...
  },
  {
    ...
    description:
      "Handcrafted from premium leather, this backpack combines style with functionality for the modern professional.",
    price: 189.0,
  ...
  },
  {
    ...
    description:
      "Revitalize your skin with our all-natural, cruelty-free face serum enriched with vitamins.",
    price: 78.0,
    originalPrice: 98.0,
  ...
  },
  {
    ...
    description:
      "Extra-thick, non-slip yoga mat designed for comfort and stability during your practice.",
    price: 68.0,
  ...
  },
  {
    ...
    description:
      "Handmade ceramic coffee set that brings elegance to your morning routine.",
    price: 124.99,
  ...
  },
  {
    ...
    description:
      "Stay hydrated in style with our eco-friendly, insulated water bottle.",
    price: 34.99,
  ...
  },
  {
    ...
    description:
      "Protect your eyes with style. UV400 protection meets timeless design.",
    price: 156.0,
    originalPrice: 195.0,
  ...
  },
  {
    ...
    description:
      "Track your health and fitness goals with our advanced activity monitor.",
    price: 199.99,
