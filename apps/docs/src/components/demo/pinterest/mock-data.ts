...
const pinContents = {
  Design: [
    ...
    },
    {
      ...
      content:
        "Stay ahead of the curve with these cutting-edge UI design trends. From glassmorphism to 3D elements, discover what's shaping digital experiences.",
      steps: [
  ...
  Art: [
    {
      ...
      content:
        "Master the art of abstract watercolor painting with these professional techniques. Create stunning pieces that capture emotion through color and flow.",
      materials: [
        "Watercolor paper",
        "Quality brushes",
        "Watercolor paints",
  ...
  Photography: [
    {
      ...
      content:
        "Capture stunning portraits during the magical golden hour. Learn how to use natural light to create warm, glowing photographs.",
      steps: [
  ...
  Fashion: [
    {
      ...
      content:
        "Build a versatile wardrobe with these timeless pieces. Mix and match to create countless outfits with minimal items.",
      materials: [
        "White t-shirt",
        "Black blazer",
        "Blue jeans",
  ...
  Food: [
    {
      ...
      content:
        "A delicious and healthy dinner ready in 30 minutes. This Mediterranean-inspired dish is packed with flavor and nutrients.",
      ingredients: [
        "Olive oil",
        "Garlic",
        "Cherry tomatoes",
  ...
  DIY: [
    {
      ...
      content:
        "Create a boho-chic macrame wall hanging for your home. This beginner-friendly project adds texture and warmth to any space.",
      materials: [
        "Macrame cord",
        "Wooden dowel",
        "Scissors",
  ...
  Home: [
    {
      ...
      content:
        "Maximize every inch of your small space with these clever organization solutions. Transform clutter into calm.",
      steps: [
...
export const pinterestItems: PinterestItem[] = imageIds.map(
  (imageId, index) => {
    const category = categories[index % categories.length];
    const categoryContents =
      pinContents[category as keyof typeof pinContents] || [];
    const contentData = categoryContents[index % categoryContents.length] ||
      categoryContents[0] || {
...
export function getRelatedPins(
  currentId: string,
  limit: number = 6,
): PinterestItem[] {
