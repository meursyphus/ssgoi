---
title: "SSGOI 소개"
description: "웹에서 네이티브 앱과 같은 자연스러운 페이지 전환 애니메이션을 구현하는 라이브러리"
nav-title: "소개"
---
...
- [설치하기](./02.installation.md) - 5분 안에 시작하기
- [빠른 시작](./03.quick-start.md) - 첫 번째 애니메이션 만들기
- [예제 둘러보기](../02.examples/01.basic-transitions.md) - 다양한 전환 효과 체험
