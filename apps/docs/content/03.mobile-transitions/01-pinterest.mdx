...
<Tabs items={[{ label: "React", value: "react" }, { label: "Svelte", value: "svelte" }, { label: "Vue", value: "vue" }, { label: "Solid.js", value: "solid" }, { label: "Angular", value: "angular" }]}>
  ...
  <TabPanel value="vue">
    ...
    import { pinterest } from '@ssgoi/vue/view-transitions';

    const config = {
      defaultTransition: pinterest()
    };
    </script>
  ...
  <TabPanel value="solid">
    ...
    import { pinterest } from '@ssgoi/solid/view-transitions';
...
You can adjust the spring physics configuration through the `physics` option:
...
The default configuration uses built-in spring settings.
