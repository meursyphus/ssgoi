  ...
  items={[
    {
      ...
      suitable: "yes",
      description: "Moving between completely independent sections (Home → Settings)",
    },
    {
    ...
    },
    {
      ...
      suitable: "no",
      description: "Expansion transitions like hero recommended for parent-child structures",
    },
  ]}
/>
