...
SSGOI combines **Web Animation API** with a **Spring Physics Engine** for the best performance.

- **Web Animation API Based**: Pre-computes spring physics into keyframes, minimizing main thread load
- **GPU Acceleration**: 60fps animations using compositing layer properties like transform and opacity
- **Animation State Memory**: Smooth transitions even with browser back/forward navigation
- **Natural Physics-Based Motion**: Spring animations for organic, non-mechanical movement
- **Small Bundle Size**: < 20KB gzipped, Tree-shaking support
...
<Note type="info">
  SSGOI officially supports React, Svelte, Vue, and Angular.
</Note>
