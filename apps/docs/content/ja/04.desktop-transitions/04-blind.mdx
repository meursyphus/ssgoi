...
<Tabs items={[{ label: "React", value: "react" }, { label: "Svelte", value: "svelte" }, { label: "Vue", value: "vue" }, { label: "Solid.js", value: "solid" }, { label: "Angular", value: "angular" }]}>
  ...
  <TabPanel value="vue">
    ...
    import { blind } from '@ssgoi/vue/view-transitions';
  ...
  <TabPanel value="solid">
    ...
    import { blind } from '@ssgoi/solid/view-transitions';
...
// スムーズなトランジション
blind({
  outPhysics: { spring: { stiffness: 60, damping: 20 },
  inPhysics: { spring: { stiffness: 50, damping: 18 },
});
