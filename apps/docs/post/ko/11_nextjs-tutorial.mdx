---
title: "Next.js에서 SSGOI로 페이지 트랜지션 구현하기"
...
![템플릿 데모 - 하단 탭으로 Posts, Products, Gallery, Profile 이동](/post/nextjs-tutorial/demo-overview.gif)
...
![Drill 트랜지션 - 리스트에서 상세로 들어갔다가 나오기](/post/nextjs-tutorial/drill-transition.gif)
...
![Slide 트랜지션 - 탭 클릭 시 좌우 슬라이드](/post/nextjs-tutorial/slide-transition.gif)
...
![Pinterest 트랜지션 - 이미지가 확대되면서 상세로 전환](/post/nextjs-tutorial/pinterest-transition.gif)
...
![Instagram 트랜지션 - 그리드에서 상세로 전환, 갤러리 유지](/post/nextjs-tutorial/instagram-transition.gif)
