      ...
      <div class="grid grid-cols-2 gap-3">
        {#each products as product (product.id)}
          <div class="block bg-white/5 rounded-xl overflow-hidden">
            ...
            <div class="p-3">
              <span
                class="text-[10px] text-neutral-500 uppercase tracking-wide"
              >
                {product.category}
              </span>
              <h3
                class="text-xs font-medium text-white mt-0.5 line-clamp-2 leading-tight"
              >
                {product.name}
              </h3>
              ...
              <div
                class="flex items-center gap-1 mt-1.5 text-[10px] text-neutral-400"
              >
