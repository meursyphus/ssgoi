...
export const products: Product[] = [
  ...
  },
  {
    ...
    description:
      "Handcrafted from premium leather, this backpack combines style with functionality.",
    price: 189.0,
  ...
  },
  {
    ...
    description:
      "Revitalize your skin with our all-natural, cruelty-free face serum.",
    price: 78.0,
    originalPrice: 98.0,
  ...
  },
  {
    ...
    description:
      "Extra-thick, non-slip yoga mat designed for comfort and stability.",
    price: 68.0,
...
export function useRelatedProducts(currentId: string, limit: number = 4) {
  const currentProduct = useProduct(currentId);
