...
const pinContents = {
  ...
  Art: {
    ...
    content:
      "Master the art of abstract watercolor painting with these professional techniques.",
    materials: [
      "Watercolor paper",
      "Quality brushes",
      "Watercolor paints",
  ...
  Photography: {
    ...
    content:
      "Capture stunning portraits during the magical golden hour. Learn how to use natural light.",
    steps: [
  ...
  Home: {
    ...
    content:
      "Maximize every inch of your small space with these clever organization solutions.",
    steps: [
...
const savesValues = [
  1234, 2456, 3678, 890, 4123, 567, 2890, 1567, 3234, 789, 4567, 1890, 2345, 678,
  3456,
];
const followersValues = [
  5432, 8765, 3210, 9876, 6543, 4321, 7654, 2109, 8901, 5678, 3456, 7890, 1234,
  6789, 4567,
];

export const pinterestItems: PinterestItem[] = Array.from(
  { length: 15 },
  (_, index) => {
    const category = categories[index % categories.length];
    const contentData = pinContents[category as keyof typeof pinContents];
    ...
    return {
      ...
      image: `https://picsum.photos/seed/pin${index}/400/600`,
